      ...
      <div className="login-content">
        ...
        <div className="login-form-wrapper">
          <div className="login-form-inner">
            ...
            <p className="login-subtitle">Join Tourify to start planning your dream trips.</p>

            <div className="login-tabs">
              <Link to="/login" className="login-tab" style={{ textDecoration: 'none' }}>Sign In</Link>
              <Link to="/register" className="login-tab active" style={{ textDecoration: 'none' }}>Create Account</Link>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-group" style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '14px', color: 'var(--color-text-muted)' }}>
                <input 
                  type="checkbox" 
                  id="terms" 
                  required 
